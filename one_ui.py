...
" ")
        ...
        self.goNextPage = QtWidgets.QPushButton(self.frame)
        self.goNextPage.setMinimumSize(QtCore.QSize(150, 150))
        self.goNextPage.setMaximumSize(QtCore.QSize(150, 150))
...
"}\n"
" ")
        self.goNextPage.setText("")
        self.goNextPage.setObjectName("goNextPage")
        self.gridLayout.addWidget(self.goNextPage, 4, 2, 1, 1)
